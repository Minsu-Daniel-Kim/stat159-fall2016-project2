...
In order to predict the target variable, balance, we fit and tune five different regression models namely OLS, Lasso, Ridge, PLSR and PCR and later compare the result using Mean Square Error. For each model, we follow the exact procedure in the following.
